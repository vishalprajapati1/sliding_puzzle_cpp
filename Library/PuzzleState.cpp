...
PuzzleState::PuzzleState(grid puzzle, std::pair<int, int> cavity) {
  ...
  PuzzleState PuzzleState::move(int direction) {
 ...
 PuzzleState::PuzzleState(int size) { 
 ...
 bool PuzzleState::validMove(int move) {
 ...
 int PuzzleState::size() const { return puzzle_.size(); }
 ...
 std::size_t PuzzleState::custom_hash::operator()(const PuzzleState& p) const {
